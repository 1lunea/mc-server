...
execute if entity @e[tag=ija-a4-lang-es,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n ¡Llegaste a la fase 1: Las planicies!","color":"gold"},{"text":"\n Suficientes flores y arboles crecen aquí como para sustentar una vida.","color":"yellow"},{"text":"\n  ➡ Clic para abrir la configuración.","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"Abrir el\nmenu de opciones."}}]
execute if entity @e[tag=ija-a4-lang-fr,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n Vous avez atteint la phase 1: Les Plaines!","color":"gold"},{"text":"\n Assez de fleurs et d'arbres y poussent pour durer toute une vie.","color":"yellow"},{"text":"\n  ➡ Cliquez pour ouvrir les paramètres.","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"Ouvrir le\nmenu des paramètres."}}]
execute if entity @e[tag=ija-a4-lang-hu,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n Elérted a(z) 1.: Puszta fázist!","color":"gold"},{"text":"\n Elég virág és fa nő itt, hogy kitartson egy életre.","color":"yellow"},{"text":"\n  ➡ Kattints a beállítások megnyitásához.","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"Beállítások\nmegnyitása."}}]
execute if entity @e[tag=ija-a4-lang-uk,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n Ви досягли фази 1: Рівнини!","color":"gold"},{"text":"\n Тут ростуть квіти і дерева, яких вистачить на все життя.","color":"yellow"},{"text":"\n  ➡ Натисніть, щоб відкрити налаштування.","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"Відкрити меню налаштувань."}}]
execute if entity @e[tag=ija-a4-lang-zh,scores={ija-a4-counter=49}] run tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n 你到达了阶段1: 平原！","color":"gold"},{"text":"\n 这里生长的花草足够用一辈子了。","color":"yellow"},{"text":"\n  ➡ 点击以打开设置。","italic":true,"color":"gray","clickEvent":{"action":"run_command","value":"/trigger ija-a4-trigger set 1"},"hoverEvent":{"action":"show_text","value":"打开\n设置菜单"}}]
