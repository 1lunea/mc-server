...
execute if score @s TreeCapitator matches 103 run function treecapitator:z_options/axe_types/diamond_axe/edit/logs/cherry/enable
execute if score @s TreeCapitator matches 104 run function treecapitator:z_options/axe_types/diamond_axe/edit/logs/cherry/disable