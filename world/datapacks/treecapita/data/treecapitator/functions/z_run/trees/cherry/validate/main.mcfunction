...
function treecapitator:z_run/trees/cherry/validate/loop
execute if score ValidTree tc.value matches 1 run function treecapitator:z_run/trees/cherry/validate/whenvalid