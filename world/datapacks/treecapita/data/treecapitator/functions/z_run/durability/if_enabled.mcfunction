...
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{id:"minecraft:unbreaking","lvl":1}]}}}] run scoreboard players operation @s tc.damage /= 2 tc.value
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{id:"minecraft:unbreaking","lvl":2}]}}}] run scoreboard players operation @s tc.damage /= 3 tc.value
execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{id:"minecraft:unbreaking","lvl":3}]}}}] run scoreboard players operation @s tc.damage /= 4 tc.value
